...
```{r}
df_sim_data <-data.frame(data_sim)
ggplot(df_sim_data, aes(data_sim)) + geom_histogram()
...
```{r}
data_sim_mean <- mean(df_sim_data$data_sim)
data_sim_sd <- sd(df_sim_data$data_sim)
data_sim_mean
data_sim_sd
