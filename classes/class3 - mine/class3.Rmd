...
```{r}
for(i in 1:10){
  print(paste(i, "square =", i^2))
}

try_list <- c('some', 'some 2', 'some 3')
for(n in try_list){
  print(n)
}
...
counter <- 1
while (counter <= 17) {
  print(paste("counter is on:", counter))
  counter <- counter + 1
}
```
```{r}
number <- 0
list_nr <- c(-3, 9, 0, -7, 5, 6, -2, 3)
...
if(number > 0){
  ...
  print(paste(number, "is 0"))
}
  
}


number_function_ex <- function(list){
  for(elm in list){
    if(elm > 0){
  print(paste(elm, "is positive"))
}else if(elm < 0){
  print(paste(elm, "is negative"))
}else{
  print(paste(elm, "is 0"))
}
  }
}

number_function_ex(list_nr)
```
```{r}
calc_function_ex <-  function(a, b){
  area = a*b
  print(paste("the area of given rectangle is:", area))
}
calc_function_ex(3, 9)
```
...
Hint A1* under Hints
```{r}
calc_fun_pos_100 <- function(base){
for(i in 1:100){
base <- base + i
}
print(paste("the sum of first 100 positive intageres is", base))  
}
...
counter <- 10
while(counter >= 0){
  ifelse(counter == 0, print("Lift off!"), print(counter))
  counter = counter - 1
}
...
```{r}
int_list <- c(-4, 7, 23, -120309, 0)
for(int in int_list){
  if(int>0){
    print(paste(int, "is positive"))
  }else if(int<0){
    print(paste(int, "is negative"))
  }else{
    print(paste(int, "is neither positive nor negative"))
  }
}
...
for(age in age_list){
  if(age < 12){
    print(paste("this child is", age, "years old"))
  }else if( age >= 12 & age < 18){
    print(paste("this teenager is", age, "years old"))
  }else if(age >= 18 & age < 65){
    print(paste("this adult is", age, "years old"))
  }else{
     print(paste("this senior is", age, "years old"))
  }
}
```
